...
const socialLinks = [
  ...
  {
    href: "https://discord.gg/AW4bZrP553",
    label: "Discord",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
  ...
  {
    href: "https://instagram.com/omniplatform",
    label: "Instagram",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
  ...
  {
    href: "https://youtube.com/@omniplatform",
    label: "YouTube",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-3 text-[13px] text-muted-foreground leading-relaxed">
              Free desktop app to build AI agents for any task. Available for Windows, macOS & Linux.
            </p>
        ...
        <div className="mt-10 pt-6 border-t border-border/50 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} Omni. All rights reserved.
          </p>
          <p className="text-xs text-muted-foreground">
            Build AI agents that run locally on your machine.
          </p>
        </div>
      </div>
    </footer>
